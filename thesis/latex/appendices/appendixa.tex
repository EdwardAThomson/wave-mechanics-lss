...
This contains all the solutions of \ref{one} but also all of the linear combinations of equation \ref{two}. This is very important. Set $\psi = e^{i\beta} $, then in \ref{one} only $\beta$ is linearly dependent on t but in equation \ref{two} both $\alpha$ and $\beta$ are time dependent.
...
\noindent Also this equation resembles a hydrodynamic equation, namely the flux $u$ is vortex free and acted on by conservative forces.[2]
...
\noindent This form of the energy as volume integral over kinetic and potential energy-density obviously. This can also be re-written in another form:
