...
\label{app_mtrans}
This derivation shows the mathematical equivalence of the Schr\"odinger equation and the Continuity equation of fluid dynamics
\noindent Schr\"odinger equation. This is similar to the translated Madelung paper but uses notation that is consistent with this thesis and that of Short. The role of the pressure term is discussed elsewhere and is extracted out from this derivation in the appropriate place.
\begin{equation}
i\nu\frac{\partial\psi}{\partial t}= -\frac{\nu^2}{2}\nabla^2\psi + V\psi
\end{equation}

\noindent Apply the Madelung transform with the positive signed exponential. The dynamics for a negative signed exponential are the same but require a sign change in the definition of the potential $V$, this derivation is not provided as it is otherwise the same as the following derivation.
\begin{equation}
...
\noindent Note the expressions for V (Bernoulli equation) and P:
\begin{equation}
