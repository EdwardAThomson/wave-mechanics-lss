...
\begin{equation}
\label{taylor}
U (\mathbf{R} + \mathbf{r}) = \phi_0 \int \rho\;dV + \partial_i \phi \int \rho \mathbf{r_i}\;dV + \frac{1}{2}\partial_{ij} \phi \int \rho \mathbf{r_i} \mathbf{r_j}\;dV + \ldots
\end{equation}
...
\begin{eqnarray}
U^{(q)} &=& \frac{1}{2}(\partial_{ij} \phi) Q_{ij} = \frac{1}{2}(\partial\partial \phi)\cdot\cdot Q \\
&=& \frac{1}{2}\left[ (\partial_{xx} \phi) Q_{xx} + (\partial_{xy} \phi) Q_{xy} + (\partial_{xz} \phi) Q_{xz} \right. \nonumber \\
&& \left. +\, (\partial_{yx} \phi) Q_{yx} + (\partial_{yy} \phi) Q_{yy} + (\partial_{yz} \phi) Q_{yz} \right. \nonumber \\
&& \left. +\, (\partial_{zx} \phi) Q_{zx} + (\partial_{zy} \phi) Q_{zy} + (\partial_{zz} \phi) Q_{zz} \right]
\end{eqnarray}
...
\begin{equation}
\mathbf{F} (\mathbf{R} +\mathbf{r}) = \nabla \otimes U (\mathbf{R }+ \mathbf{r}) = \partial_i(\phi_0) \int \rho\;dV + \partial_i(\partial_j \phi) \int \rho \mathbf{r_j}\;dV + \frac{1}{2}\partial_i(\partial_{jk} \phi) \int \rho \mathbf{r_j} \mathbf{r_k}\;dV + \ldots
\end{equation}
...
\begin{eqnarray}
\label{quadforce}
\mathbf{F}^{(q)} &=& \frac{1}{2}\partial_i(\partial_{jk} \phi) \int \rho \mathbf{r_j} \mathbf{r_k}\;dV \\
&=& \frac{1}{2}\partial_i(\partial_{jk} \phi) Q_{jk} \\
&=& \frac{1}{2}\partial_i \left(\begin{array}{ccc}
...
\begin{eqnarray}
\mathbf{F} (R +r^{(1)}) = \partial_i(\phi_0) \int \rho\;dV + \partial_i(\partial_j \phi) \int \rho \mathbf{r}^{(1)}_j\;dV \\
...
\begin{eqnarray}
m \frac{\partial^2}{\partial t^2} (\mathbf{r}^{(1)} + \mathbf{r}^{(2)}) = 2m \partial_i(\phi_0) + m \partial_i(\partial_j \phi) (\mathbf{r}^{(1)}_j + \mathbf{r}^{(2)}_j) \\
m \frac{\partial^2}{\partial t^2} (\mathbf{r}^{(1)} - \mathbf{r}^{(2)}) = m \partial_i(\partial_j \phi)  (\mathbf{r}^{(1)}_j - \mathbf{r}^{(2)}_j)
\end{eqnarray}
...
\begin{equation}
m \left(\mathbf{r}^{(1)}_j - \mathbf{r}^{(2)}_j\right) = m [(x,0,0) - (-x,0,0)] = 2m (x,0,0)
\end{equation}
...
\begin{eqnarray}
U^q = \frac{1}{2} B\cdot\cdot S &=& \frac{1}{2}\int \rho\; B_{ij} (r \sigma)_{ij} \;dV = \frac{1}{2}\int \rho\; (B_{xx} r_{xx}\sigma_{xx} + B_{xy} r_{xy}\sigma_{xy} + B_{xz} r_{xz}\sigma_{xz} + \ldots) \;dV \nonumber \\
&=& \frac{1}{2}\sum_j m_j \; ( (B_{xx})_j (r_{xx}\sigma_{xx})_j + (B_{xy})_j (r_{xy}\sigma_{xy})_j + \ldots)
\end{eqnarray}
